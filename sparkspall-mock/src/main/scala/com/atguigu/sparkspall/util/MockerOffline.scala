...
import com.atguigu.sparkspall.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
...
object MockerOffline {
  ...
  def mockUserAction()={
    ...
    val startDate = new   SimpleDateFormat("yyyy-MM-dd").parse("2018-01-01")
    val endDate = new   SimpleDateFormat("yyyy-MM-dd").parse("2018-12-")
